...
# TP支持
from nanovllm.utils.tp import get_tp_size, get_tp_rank, tp_all_reduce
...
class ColumnParallelLinear(LinearBase):
    ...
    def weight_loader(self, param: nn.Parameter, loaded_weight: torch.Tensor):
        ...
        if loaded_weight.size(self.tp_dim) == param_data.size(self.tp_dim):
...
class MergedColumnParallelLinear(ColumnParallelLinear):
    ...
    def weight_loader(self, param: nn.Parameter, loaded_weight: torch.Tensor, loaded_shard_id: int):
        ...
        if loaded_weight.size(self.tp_dim) == shard_size:
            ...
            param_data.copy_(loaded_weight)
            return
        if loaded_weight.size(self.tp_dim) == shard_size * self.tp_size:
